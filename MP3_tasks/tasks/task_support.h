...
void task_list_add_tail_mp3(list_t *, int priority);
void task_list_sort(list_t **, int sort_type, int sort_order);
...
void task_list_stats(list_t *, list_t *, list_t *);        /* prints size of each list */
